...
pub fn readTimestamps(allocator: std.mem.Allocator, path: []const u8) ![]u32 {
...
pub fn matchAlignedFrames(
    ...
    var matches = std.ArrayList(FramePairs){};
